##
# > recommended MET filters for Run3 (https://twiki.cern.ch/twiki/bin/viewauth/CMS/MissingETOptionalFiltersRun2#Run_3_recommendations)
#   Flag_goodVertices
...
metFilters = cms.EDProducer("METFilters",
                            tab_name   = cms.string("METfilter"),
                            bits       = cms.InputTag("TriggerResults","","PAT"),
                            filters    = cms.vstring(METfilters)
)

metFiltersTable = cms.Sequence(metFilters)



### ---- TENTATIVO FALLITO ---- ###
# > implement MET filters following the (twiki https://twiki.cern.ch/twiki/bin/view/CMSPublic/WorkBookMetAnalysis#7_7_5_MET_Filters)
...
#    #HBHENoiseFilterResultProducer  * #Run3 recommentdation : HBHE/HBHEiso filter not needed
#    #HBHENoiseFilter *
#    #HBHENoiseIsoFilter *
